...
int main()
{
	...
	Mat img13 = imread("ss.jpg");
	clock_t t5, t6,t14,t15;
	t5 = clock();
	...
	cvWaitKey(2000);
	t14 = clock();
	cv::cvtColor(img12, img13, COLOR_RGB2GRAY);
	t15 = clock();
	auto delta5 = t15 - t15;
	auto delta = t6 - t5;
	cout <<"ourtime_Phoshop: "<<delta << endl;
	cout << "defoult time gray filtr:  " << delta5 << endl;
	/******Test rgb to ycbcr******/
	...
	auto delta2 = t8 - t7;
	auto delta3 = t10 - t9;
	cout << "ourTimeRGB2Ycrcb:  " << delta2 << "   defoultTimeRGB2YCrcb:  " << delta3 << endl;
	/******Test increase brightness******/
	clock_t t16, t17,t18,t19;
	Mat img14 = imread("ss.jpg");
	Mat img15 = imread("ss.jpg");
	t16 = clock();
	bPLUSrgb(img14);
	t17 = clock();
	t18 = clock();
	...
	auto delta7 = t17 - t16;
	auto delta8 = t19 - t18;
	cout<<"PSNR:  "<<oupsnr(img14, img15)<<endl;
	cout << "time brightness RGB: " << delta7 << endl;
	cout << "time brightness Ycrcb: " << delta8 << endl;

	imshow("increase brightness by RGB", img14);
	waitKey(2000);
	imshow("increase brightness by RGB", img15);
	waitKey(2000);
